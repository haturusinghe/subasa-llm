...
python main.py --exp_save_name Meta-Llama-3.1-8B-Instruct-bnb-4bit-base-SUHS --wandb_project unsloth_Llama-3.1-8B-Instruct-FTandEval-SUHS --pretrained_model unsloth/Meta-Llama-3.1-8B-Instruct-bnb-4bit --per_device_train_batch_size 4 --test True --hf_model_path unsloth/Meta-Llama-3.1-8B-Instruct-bnb-4bit --dataset suhs 

python main.py --exp_save_name Llama-3.2-3B-Instruct-base-SUHS --wandb_project unsloth_Llama-3.2-3B-Instruct-FTandEval-SUHS --pretrained_model unsloth/Llama-3.2-3B-Instruct --per_device_train_batch_size 4 --test True --hf_model_path unsloth/Llama-3.2-3B-Instruct --dataset suhs

python main.py --exp_save_name mistral-7b-instruct-v0.3-bnb-4bit-base-SUHS --wandb_project mistral-7Bv0.3-Instruct-FTandEvalv2-SUHS --pretrained_model unsloth/mistral-7b-instruct-v0.3-bnb-4bit --per_device_train_batch_size 4 --test True --hf_model_path unsloth/mistral-7b-instruct-v0.3-bnb-4bit --dataset suhs 